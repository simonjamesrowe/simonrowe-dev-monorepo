...
- Java 21 (backend), TypeScript (frontend) + Spring Boot 3.5.x, Spring AI 1.1.2 (Google Gemini starter, MCP Server WebMVC, Chat Memory), Spring WebSocket (STOMP), Bucket4j, React 19, @stomp/stompjs (009-profile-chat)
